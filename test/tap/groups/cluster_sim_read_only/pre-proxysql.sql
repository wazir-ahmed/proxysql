-- The simulator connects to the SQLite server as root/root; enable_readonly_testing()
...
-- TEST_READONLY's compiled-in default of 0.0.0.0:3306. Restore 0.0.0.0:3306 so
-- the simulator (proxysql:3306 from the test-runner) can reach sqliteserver.
