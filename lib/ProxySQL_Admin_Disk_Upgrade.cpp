...
void ProxySQL_Admin::disk_upgrade_mysql_servers() {
	...
	// Issue #5547: Upgrade mysql_aws_aurora_hostgroups from V2_0_9 to V2_0_10 (adds autopurge_missing_checks)
	...
	if (rci) {
		// upgrade is required
		proxy_warning("Detected version v2.0.9 of mysql_aws_aurora_hostgroups\n");
		proxy_warning("ONLINE UPGRADE of table mysql_aws_aurora_hostgroups in progress\n");
